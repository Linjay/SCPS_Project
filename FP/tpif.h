...
/* $Id: tpif.h,v 1.8 1999/11/22 15:52:45 scps Exp $ */
/* $Header: /home/cvsroot/SCPS_RI/FP/tpif.h,v 1.8 1999/11/22 15:52:45 scps Exp $ */
...
#define scps_socket(family, type, protocol)      socket((family),(type),(protocol))
#define scps_bind(sockfd, addr, addlen)          bind((sockfd),(addr),(addlen))
#define scps_connect(sockfd, servaddr, addrlen)  connect((sockfd),(servaddr),(addrlen))
#define scps_listen(sockfd, backlog)             listen((sockfd),(backlog))
#define scps_accept(sockfd, peer, addrlen)       accept((sockfd),(peer),(addrlen))
#define scps_send(sockfd, buff, nbytes, flags)   send((sockfd),(buff),(nbytes),(flags))
#define scps_recv(sockfd, buff, nbytes, flags)   recv((sockfd),(buff),(nbytes),(flags))
#ifdef MSVC
#define scps_close(sockfd)                       closesocket((sockfd))
#else
#define scps_close(sockfd)                       close((sockfd))
#endif
